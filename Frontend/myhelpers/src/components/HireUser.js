...
//         if (hireUser.length !== 0) {
//             console.log("hireUser ::", hireUser);
//             // hireUser.map((val)=> values.r_id === val.user_id)
//             // console.log("hireUser ::", hireUser.length !== 0 ? hireUser.map((val)=>console.log("H110"===val.user_id)):null);
//         }
//     }, [hireUser])
...
//                             {
//                                 // status = { hireUser.length !== 0 ? console.log(hireUser.user_id) ? true : false : false },
//                                 hireUser.length !== 0 && displayData.length !== 0 ?
//                                     hireUser.map((val, index) =>
