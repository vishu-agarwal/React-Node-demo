...
const Login = () => {
    ...
    const loginSubmitHandler = (event) => {
        ...
        if (values.email.length !== 0) {
            ...
            if (otp == parseInt(otpUser)) {
                ...
                setValues((prevState) => { return { ...prevState, email: "" } })
                setotp("")
            }
            else {
                setState({ snackOpen: true });
    ...
    const onChangeEmail = (event) => {
        setValues((prevState) => { return { ...prevState, email: event.target.value } })
                ...
                <CardContent >
                    ...
                    <Grid align="center" >
                        ...
                        <form onSubmit={loginSubmitHandler}>
                            ...
                            <Grid xs={12} sm={12} item>
                                {!isOtp ?
                                    <Button onClick={sendOtpHandler} variant="contained" fullWidth sx={{ height: 50, marginTop: 3, backgroundColor: "#163758" }}>
                                        Send OTP
                                    </Button>
                                    :
                                    <Button type='submit' variant="contained" fullWidth sx={{ height: 50, marginTop: 1, backgroundColor:"#163758" }}>
                                        Login
                                    </Button>
                                }
                                {isOtp &&
                                    <Button onClick={sendOtpHandler} color="primary" fullWidth sx={{ marginTop: 1 }}>
                                        Resend Otp
                                    </Button>
                                }
                            </Grid>
